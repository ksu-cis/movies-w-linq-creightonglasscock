...
namespace Movies.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public void OnGet()
        {
            Movies = MovieDatabase.All.OrderBy(movie => (movie.Title, movie.Director));
        }
        ...
        public void OnPost()
        {
            ...
            if (maxIMDB != null)
            {
                Movies = Movies.Where(movie => movie.IMDB_Rating != null).Where(movie => movie.IMDB_Rating <= minIMDB);
            }
            ...
            if (sort != null)
            {
                Movies = Movies.OrderBy(movie =>
                {
                    switch (sort)
                    {
                        ...
                        case "year": return movie.Release_Year;
                        case "imdb": return movie.IMDB_Rating.ToString();
                        case "rt": return movie.ToString();
                        default: return movie.Title;
                    }
                });
